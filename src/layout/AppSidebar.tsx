...
const AppSidebar: React.FC = () => {
          ...
          <li key={nav.name} className="relative">
            ...
            >
              ...
              >
                ...
                {showDotBadge && (
                  <span className="absolute -top-1 -right-1 h-3 w-3 rounded-full bg-red-500 dark:bg-red-600"></span>
                )}
              </span>
  ...
  return (
    ...
    >
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar dark:bg-gray-900">
        <nav className="mb-6 mt-10">
          <div className="flex flex-col gap-6">{renderMenuItems(navItems)}</div>
        </nav>
      </div>
    </aside>
  );
