    ...
    return (
        <div className="mt-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3 bg-white p-4 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="flex items-center gap-2">
              ...
              ${filter.status === status.toLowerCase() ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}
                    >
                        {status}
                    </button>
                ))}
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        placeholder="Search..."
                        className="pl-9 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                </div>
                            ...
                            {sortOptions.map((option) => (
                                <div
                                    ...
                                    className={`px-4 py-2 text-sm cursor-pointer hover:bg-gray-100 ${
                                        option.toLowerCase() === filter.sortedBy ? "text-blue-600 font-medium" : "text-gray-700"
                                    }`}
                                >
                                    {option}
                                </div>
